...
Jest to drugi krok potoku Modelu 2 z m5l4: po tym, jak `/create-skill` wyprodukuje `skills/code-review/SKILL.md`, ta umiejętność opakowuje artefakt w pakiet, który może zostać opublikowany w AWS CodeArtifact.
...
3. Skopiuj lub utwórz strukturę artefaktów:
...
- Nie zapisuj tajnych danych AWS, tokenów ani danych uwierzytelniających konta do plików pakietu.
...
Jeśli wygenerowany pakiet zawiera umiejętności, zweryfikuj, czy każdy `SKILL.md` zaczyna się od prawidłowego frontmattera.