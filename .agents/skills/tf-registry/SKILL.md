...
Ta umiejętność odpowiada za ścieżkę zarządzanej infrastruktury z m5l4: AWS CodeArtifact udostępniony za pośrednictwem Terraform. Powinna być używana tylko wtedy, gdy uczący się świadomie wybierze ścieżkę załącznika AWS, a nie jako domyślna dla każdego zespołu.
...
Jeśli brakuje wymaganych wartości, zapytaj użytkownika o:
...
Jeśli Terraform nie jest zainstalowany lub inicjalizacja dostawcy jest niedostępna, powiedz o tym i mimo to uruchom statyczne sprawdzenia wygenerowanych plików.
