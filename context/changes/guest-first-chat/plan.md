...
- [x] 5.1 `php artisan test --compact` (filtr Chat) przechodzi — 5333e19
- [x] 5.2 Pint dirty — 5333e19
- [x] 5.3 `npm run build` sukces — 5333e19

#### Ręczne

- [x] 5.4 Smoke długiego streamu bez buforowania końca — 5333e19
- [x] 5.5 Brak migracji/tabel Conversation w tej zmianie — 5333e19
